...
public final class KeyboardUtils {
     ...
     */
    public static void showSoftInput(@NonNull Context context, @NonNull final View view, final int flags) {
     ...
     */
    public static void hideSoftInput(@NonNull Context context, @NonNull final Window window) {
     ...
     * @param view The view.
     */
    public static void hideSoftInput(@NonNull final Context context, @NonNull final View view) {
        InputMethodManager imm =
                (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
     ...
     * @param window The window.
     */
    public static void fixSoftInputLeaks(@NonNull final Activity activity, @NonNull final Window window) {
        InputMethodManager imm =
     ...
     * @return the navigation bar's height
     */
    public static int getNavBarHeight(@NonNull final Activity activity) {
